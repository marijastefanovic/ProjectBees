...
//izmenjena klasa Predstavnik zbog testiranja
    ...
    */
    public function posaljiZahtev(){
       ...
       /* $glumciModel= new GlumacModel();
        ...
        $glumciModel= Factories::models('App\Models\GlumacModel');
        $reziseriModel=Factories::models('App\Models\ReziserModel');
        $ucesnici= Factories::models('App\Models\UcesnikUFilmuModel');
        $filmovi= Factories::models('App\Models\FilmModel');
