        ...
        <script>
            function selectedElem(){
                if(document.getElementById("akcija").selected==true){
                    window.location.assign("premijere.html");
                }else{
                    window.location.assign("greska_premijere.html");
                }
            }
        </script>
        <style> body {
                ...
                <td>
                    <div style="align-items:center; display: flex;">
                        ...
                        <span style="margin-left:2ch"> <h2>BATMAN</h2> </br>
                            <table>
                                <tr>
                                    <td><h3>Premijera:</h3></br> 25.04.2022. </br><a href="film1.html"><Button>Ponedeljak 12:00</Button></a></td>
                ...
                <td>
                    <div style="align-items:center; display: flex;">
                        ...
                        <span style="margin:2ch"> <h2>UNCHARTED</h2> </br>
                            <table>
                                <tr>
                                    <td><h3>Premijera:</h3></br> 25.04.2022. </br><a href="film2.html"><Button>Utorak 12:00</Button></a></td>
                                    <!--<td>Sala 2 </br><Button>Utorak 12:00</Button></td>
                                    <td>Sala 3 </br><Button>Sreda 12:00</Button></td>-->
                                </tr>
                                <!--<tr>
